...
public class User {
	...
	@Column(name = "ers_user_id", unique = true, nullable = false)
	private int userId;
	...
	public User(String username, String password, String firstName, String lastName, String email, UserRoles roleId) {
		super();
